...
class Inbound extends events_1.default {
    ...
    _listen() {
        ...
        if (typeof this._main._opt.tls !== "undefined") {
            ...
            socket = tls_1.default.createServer({ key, cert, requestCert, ca }, (socket) => {
                this._codec = new codec_js_1.MLLPCodec(this._main._opt.encoding);
                this._onTcpClientConnected(socket);
            });
        }
        else {
            socket = net_1.default.createServer((socket) => {
                this._codec = new codec_js_1.MLLPCodec(this._main._opt.encoding);
                this._onTcpClientConnected(socket);
            });
        }
